...
# Datasets Used: 
[LCS25000](https://www.kaggle.com/datasets/javaidahmadwani/lc25000/data)
# Steps to implement:
...
Once the code is run it performs the following tasks step-by-step
     **Task 1: Extraction of zip-files** : The code extracts the zip files present in the director
